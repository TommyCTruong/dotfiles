...
function AggregateCompanyData(companyName, company, listFilter) {
  ...
  this.urlsList = urlsList.filter(function (url) {
    var urlObject = company.urls[url];
...
module.exports = function () {
  if (!this.model) {
    return bel(_templateObject || (_templateObject = _taggedTemplateLiteral(["<section class=\"sliding-subview sliding-subview--has-fixed-header\"></section>"])));
  }
  ...
  if (!overallCount) {
    return bel(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<section class=\"tracker-networks site-info site-info--full-height card\">\n        <div class=\"js-non-tracker-networks-hero\">\n            ", "\n        </div>\n        <div class=\"non-tracker-networks__explainer border--bottom--inner text--center\">\n            <p>", "</p>\n            <p>", "</p>\n        </div>\n    </section>"])), renderHero(this.model.site, overallCount), explainerText, renderAboutOurTrackingProtectionsLink());
  } else {
    var renderSection = function renderSection(aggregationStatsSection, headingText, site) {
      var headingElement = headingText ? bel(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["<li class=\"tracker-list-header border--bottom border--top padded--top-half padded--bottom-half text--center\">", "</li>"])), headingText) : bel(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["<li class=\"padded--top-half padded--bottom-half border--top text--center\"></li>"])));
      return bel(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["<ol class=\"default-list site-info__trackers__company-list ", "\">\n                ", "\n                ", "\n            </ol>"])), aggregationStatsSection.entitiesCount ? '' : 'is-hidden', headingElement, renderTrackerDetails(aggregationStatsSection.list, site));
    };
...
function getReasons(site) {
  ...
  var totalTrackerNetworkCount = site.majorTrackerNetworksCount; // Show banner if the site itself is a tracker network
  ...
  if (site.isaMajorTrackingNetwork) {
    ...
    var majorTrackersBadOrGood = totalTrackerNetworkCount !== 0 ? 'bad' : 'good';
    reasons.push({
      modifier: majorTrackersBadOrGood,
      msg: "".concat(majorTrackerNetworksText(totalTrackerNetworkCount))
    });
...
module.exports = {
  majorTrackerNetworksText: function majorTrackerNetworksText(count) {
    if (count > 0) {
