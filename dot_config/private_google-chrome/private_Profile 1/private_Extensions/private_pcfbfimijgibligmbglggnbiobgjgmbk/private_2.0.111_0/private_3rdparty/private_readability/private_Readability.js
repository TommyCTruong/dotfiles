...
Readability.prototype = {
  ...
  DEFAULT_TAGS_TO_SCORE: "section,h2,h3,h4,h5,h6,p,td,pre,img".toUpperCase().split(","),
    ...
    while (true) {
      ...
      while (node) {
        ...
        if (node.tagName === "DIV") {
          ...
          if (this._hasSinglePInsideElement(node)) {
            ...
            node = newNode;
          } else if (this._hasSynoNscImgInsideElement(node)) {
      ...
      **/
      ...
      this._forEachNode(elementsToScore, function(elementToScore) {
        ...
        var innerImg = elementToScore.querySelector('img[syno_nsc_img_node_size_score]');

        if (!innerImg && innerText.length < 25) {
          return;
        }
        ...
        if (innerImg) {
          contentScore += parseFloat(innerImg.getAttribute('syno_nsc_img_node_size_score'), 10);
        }
  ...
  **/
  ...
  _hasSynoNscImgInsideElement: function (element) {
    return !!element.querySelector('img[syno_nsc_img_node_size_score]');
  },
