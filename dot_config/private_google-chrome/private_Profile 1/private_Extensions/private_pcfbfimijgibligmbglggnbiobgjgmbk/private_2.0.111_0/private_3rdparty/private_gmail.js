...
var Gmail = function(localJQuery) {
    ...
    */
    ...
    api.tools.parse_image = function (x) {
        var images = {};
        if (!x || !x[7] || !Array.isArray(x[7][4])) {
            return images;
        }
    ...
    api.tools.parse_email_data = function(email_data) {
        ...
        for(var i in email_data) {
            ...
            if(x[0] === "ms") {
                ...
                data.threads[x[1]].attachments_details = api.tools.parse_attachment_data(x[13]);
                data.threads[x[1]].inline_images = api.tools.parse_image(x[13]);
